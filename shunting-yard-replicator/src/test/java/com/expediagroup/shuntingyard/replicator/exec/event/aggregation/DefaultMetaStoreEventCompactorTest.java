...
import com.expediagroup.shuntingyard.replicator.exec.event.aggregation.DefaultMetaStoreEventCompactor;
import com.expediagroup.shuntingyard.replicator.exec.event.aggregation.EventMerger;
...
public class DefaultMetaStoreEventCompactorTest {
  ...
  public void shouldReturnSameEventsIfEventsCannotBeMerged() {
    List<MetaStoreEvent> events = asList(mockEvent(DROP_PARTITION), mockEvent(DROP_TABLE),
